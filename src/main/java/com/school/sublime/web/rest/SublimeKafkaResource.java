...
@RestController
@RequestMapping("/api/sublime-kafka")
public class SublimeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SublimeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SublimeKafkaResource(KafkaProperties kafkaProperties) {
